...
export const PERMISSION_RULE_SEED: PermissionRuleSeed[] = [
  ...
  { role: "encoder", action: "update", subject: "Incident", conditions: { encodedBy: "$user.id" } },
  { role: "encoder", action: "delete", subject: "Incident", conditions: { encodedBy: "$user.id" } },
  ...
  { role: "dpo", action: "update", subject: "Incident" },
  { role: "dpo", action: "delete", subject: "Incident" },
  { role: "dpo", action: "restore", subject: "Incident" },
