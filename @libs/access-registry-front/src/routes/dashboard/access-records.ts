...
// routes filles (index, create, show), là où un garde par route se serait
...
export default class AccessRecordsDomainRoute extends Route {
  ...
  beforeModel() {
    return requireFeatureOrRedirect('accessRegistry', {
