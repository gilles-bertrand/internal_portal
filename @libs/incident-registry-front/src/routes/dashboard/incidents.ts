...
// routes filles (index, create, edit, show), là où un garde par route se serait
...
export default class IncidentsDomainRoute extends Route {
  ...
  beforeModel() {
    return requireFeatureOrRedirect('incidentRegistry', {
