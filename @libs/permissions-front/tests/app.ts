...
import RoleSchema from '#src/schemas/roles.ts';
import DashboardTemplate from './support/dashboard-template.gts';
...
export class TestApp extends Application {
  ...
  modules = {
    ...
    './templates/dashboard': { default: DashboardTemplate },
...
export function initializeTestApp(owner: Owner, locale: string) {
  ...
  owner.register('service:session', SessionService);
